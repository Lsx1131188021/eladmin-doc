...
function integrateGitment(router) {
    ...
    function renderGitment(parentEl, path) {
        ...
        const gitment = new Gitment({
            ...
            id: path,
            owner: 'elunez', // 必须是你自己的github账号
            repo: 'eladmin-doc', // 上一个准备的github仓库
            link: location.origin + path,
            oauth: {
                client_id: '08f039f9aac8015220ab', // 第一步注册 OAuth application 后获取到的 Client ID
                client_secret: 'b98a7d05379a0ffc7ad8d6332bee85b3790332c4', // 第一步注册 OAuth application 后获取到的 Clien Secret
            },
        })
